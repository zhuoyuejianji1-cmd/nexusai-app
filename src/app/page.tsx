          ...
          <Card className="xl:col-span-3 border-gradient overflow-hidden relative">
            ...
            <CardContent className="relative p-3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-medium text-indigo-400">今日任务</span>
                <Badge className="ml-auto text-[10px] px-1 py-0 bg-emerald-500/20 text-emerald-400 border-0">
                  🔥 7天
                </Badge>
              </div>
              <h3 className="font-heading font-bold text-white text-sm mb-0.5">掌握 ChatGPT 提示词工程</h3>
              <p className="text-[10px] text-slate-500 mb-2">学习编写有效的提示词</p>
              <div className="mb-2">
              ...
              <Button size="sm" className="w-full text-xs h-7 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500" asChild>
